...
export class ToolButtonFloat extends React.Component {
  ...
  render () {
    ...
    if ((this.props.image) || (this.props.icon)) {
      return (<div className={buttonClass} style={{"top": this.props.top, "right": this.props.right}} role="button" aria-pressed="false" onClick={(e) => this.handleIconClicked(anId)} alt={this.props.alt} title={this.props.title}>{face}</div>)
    }

    return (<div className={buttonClass} style={{"top": this.props.top, "right": this.props.right}} role="button" aria-pressed="false" onClick={(e) => this.handleIconClicked(anId)} alt={this.props.alt} title={this.props.title}>{this.props.children}</div>);
  }
}
